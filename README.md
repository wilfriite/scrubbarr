...
- **"Everyone Must See"**: Media is only deleted if _every_ user on the server has finished it.
...
- [x] Implement `SonarrService` for TV Show management (TVDB ID support).
...
_Scrubbarr: Because your hard drives deserve a break._
